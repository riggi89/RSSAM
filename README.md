...
<p align="center">
  ...
  <a href="https://github.com/riggi89/RSSAM/releases"><img alt="Version 2.0.4" src="https://img.shields.io/badge/version-2.0.4-blue"></a>
...
| --- | --- |
| `RSSAM_2.0.4-win-x64-Setup.exe` | Most Windows 10 and Windows 11 computers |
| `RSSAM_2.0.4-win-x86-Setup.exe` | 32-bit Windows installations |
| `RSSAM_2.0.4-win-x64-Portable.zip` | Portable use on 64-bit Windows |
| `RSSAM_2.0.4-win-x86-Portable.zip` | Portable use on 32-bit Windows |
